...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      'bg-surface-0 px-3 py-2 text-sm shadow-sm ring-offset-background',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('px-2 py-1.5 text-sm font-semibold text-subtext-0', className)}
    {...props}
  />
))
